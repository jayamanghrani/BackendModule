...
public class A9_BuilderPatternExample {
...
class Cake
{
	 ...
	 @Override
			public String toString() {
				return "Cake [sugar=" + sugar + ", butter=" + butter
						+ ", eggs=" + eggs + ", vanila=" + vanila + ", flour="
						+ flour + ", bakingpowder=" + bakingpowder + ", milk="
						+ milk + ", cherry=" + cherry + "]";
			}
	...
	public static class Builder {
	 ...
	 //builder methods for setting property
		        ...
		        {
		        	this.sugar = cup; 
		        	return this;    //yaha se return krana pdega , tabhi hmm sugar ke bad kuch aor call kr sakte [new Cake.Builder().sugar(1).butter(0.5)]
		        }
